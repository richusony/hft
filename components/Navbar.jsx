...
import { faClose, faBars, faUser, faHandsHoldingChild } from "@fortawesome/free-solid-svg-icons";
            ...
            <>
                <div keys={keys} className="transition duration-[1000ms] flex justify-between ease-linear p-3 text-center">
                    ...
                    <ul className={`transition duration-[1000ms] rounded p-3 md:p-0 md:bg-inherit ease-in bg-[#efeded] absolute z-10 md:static ${cname} md:opacity-100 md:translate-x-0 top-14 right-0 md:flex justify-between`}>
                        ...
                        <li className="text-xl p-3 md:p-0 md:mx-auto w-[100px] border-b-2 border-black md:border-none select-none ease-linear"><Link href='/adoption' className="transition duration-300 ease-linear hover:font-medium hover:italic" >Adoption</Link></li>
                        <li className="text-xl p-3 md:p-0 md:mx-auto w-[100px] border-b-2 border-black md:border-none select-none ease-linear"><Link href='/FAQ' className="transition duration-300 ease-linear hover:font-medium hover:italic">FAQ</Link></li>
                        <li className="text-xl p-3 md:p-0 md:mx-auto w-[100px] border-b-2 border-black md:border-none select-none ease-linear"><Link href='/yourdonations' className="transition duration-300 ease-linear hover:font-medium hover:italic"><FontAwesomeIcon icon={faHandsHoldingChild}/></Link></li>
