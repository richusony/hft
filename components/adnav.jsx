            ...
            <>
                <div keys={keys} className="transition duration-[1000ms] flex justify-between ease-linear p-3 text-center">
                    ...
                    <li className="text-xl p-3 md:p-0 md:mx-2 w-[100px] border-b-2 border-black md:border-none select-none ease-linear"><Link href="/admin/manage-blogs" className="transition duration-300 ease-linear hover:font-medium hover:italic">Blogs</Link></li>
                        ...
                        <li className="text-xl p-3 md:p-0 md:mx-2 w-[100px] border-b-2 border-black md:border-none select-none ease-linear"><Link href='/admin/feedbacks' className="transition duration-300 ease-linear hover:font-medium hover:italic" >Feedback</Link></li>
                        <li className="transition duration-[1000ms] ease-linear">{logicon ? <div className="transition duration-[1000ms] my-auto ease-in rounded-[55%]"><FontAwesomeIcon onClick={() => { dropdown ? setDropdown(false) : setDropdown(true) }} className="transition duration-[1000ms] text-2xl mt-3 md:my-auto md:p-0 md:mx-2 border-b-2 border-black md:border-none cursor-pointer select-none ease-linear hover:font-medium hover:italic" icon={faUser} /></div> : <h3 id='new' className="transition duration-150 text-xl px-2 py-1 md:mx-auto w-[100px] md:border-none select-none md:rounded md:bg-[#151522] md:text-white cursor-pointer ease-in hover:scale-95"><Link href="/admin/adlogin">Login</Link></h3>}
                            {dropdown && logicon && <div className="transition duration-[1000ms] text-white cursor-pointer px-2 py-1 rounded bg-blue-500 h-fit w-fit mx-2 ease-in hover:bg-blue-800 translate-y-2" onClick={logout}>logout</div>}</li>
