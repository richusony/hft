      ...
      <div>
        ...
        <div className='md:flex md:flex-wrap px-3'>
          <div className='mx-auto md:w-full flex justify-end space-x-2 mb-4'>
            <button onClick={() => { push('/admin/addblogs') }} className='rounded my-2 px-8 py-1 font-semibold bg-green-400 hover:bg-green-500 duration-300' >Add</button>
            <button onClick={() => { push('/admin/updateblog') }} className='rounded my-2 px-6 py-1 font-semibold bg-blue-400 hover:bg-blue-500 duration-300' >Update</button>
            <button onClick={() => { push('/admin/deleteblog') }} className='rounded my-2 px-2 py-1 font-semibold bg-red-400 hover:bg-red-500 duration-300' ><FaTrash /></button>
          </div>
