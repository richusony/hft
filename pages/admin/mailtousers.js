            ...
            <div className="bg-[#151522] py-10 px-5">
                <div className="bg-white/10 rounded p-4 mt-10 mx-auto md:w-fit md:m-auto md:py-5 md:px-10">
                    ...
                    <form action='' className="flex-row mx-auto w-full md:flex-col md:w-fit md:m-auto">
                        <textarea type="text" placeholder="Type Something..." cols={20} rows={10} className="w-fit mx-auto p-3 placeholder:p-3 rounded mb-3 bg-inherit border md:w-fit block text-white" onChange={(e) => { setMsg(e.target.value) }} required />
