...
const deleteblog = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await toast.promise( fetch('/api/deletegallery', {
            method: 'POST',
            headers: {
        ...
        <>
            ...
            <ToastContainer
                ...
                <div className="bg-white/10 rounded p-4 mt-10 mx-auto md:w-fit md:m-auto md:py-5 md:px-10">
                    <h1 className="text-white text-3xl text-center py-3 mb-5">Remove Gallery</h1>

                    <form action='' className="flex-row mx-auto w-full md:flex-col md:w-fit md:m-auto">
                        <input type="text" placeholder="Gallery id" className="w-fit mx-auto p-3 placeholder:p-3 rounded h-10 mb-3 bg-inherit border md:w-fit block text-white" onChange={(e) => { setId(e.target.value) }} required />
