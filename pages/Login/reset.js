        ...
        <>
            <div className="bg-[#151522] p-5 w-full">
                ...
                <div className="flex-row w-72 h-80 text-center mx-auto border px-3 mt-10">
                    ...
                    <input type="email" placeholder="email" className="block w-fit mx-auto placeholder:p-3 rounded h-10 mb-3 bg-inherit border text-white" required onChange={(e) => setEmail(e.target.value)} />
