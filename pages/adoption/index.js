        ...
        <>
            <div>
                <div className='w-full text-center bg-cover font-bold flex justify-center items-center bg-family md:bg-family2 shadow-2xl bg-fixed px-5 md:py-60 py-80 rounded-b-lg'>
                    <h1 className='transition duration-150 text-4xl text-white tracking-wide font-medium ease-linear'><span className='text-[#ff6600]'>Every child </span>deserves home and<br/> love Period</h1>
                </div>
